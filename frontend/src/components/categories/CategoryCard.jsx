    ...
    <Card className="relative overflow-hidden rounded-[28px] p-6">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <h3 className="mt-4 text-2xl font-semibold text-slate-900">{category.name}</h3>
          <p className="mt-2 text-sm text-slate-500">
            Icone: <span className="font-medium text-slate-700">{category.icon || 'Nao definido'}</span>
          </p>
        </div>

        <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-slate-200 bg-slate-50 text-xs font-semibold uppercase text-slate-700">
        ...
        <div>
          ...
          <div className="mt-3 flex items-center gap-3">
            <span
              ...
              style={{ backgroundColor: category.color || '#10b981' }}
            />
            <p className="text-sm font-medium text-slate-700">{category.color || 'Nao definida'}</p>
          </div>
        </div>
        <div>
          <p className="text-xs uppercase tracking-[0.24em] text-slate-500">Categoria pai</p>
          <p className="mt-3 text-sm font-medium text-slate-700">{category.parentName || 'Sem categoria pai'}</p>
        </div>
      </div>
